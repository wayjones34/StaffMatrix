...
{
    /// <summary>
    /// Simple console test runner for shift assignment functionality
    /// </summary>
    class TestRunner
    {
        static void Main(string[] args)
        {
            ...
            {
                RunShiftAssignmentTests();
                return;
            }
            
            Console.WriteLine("Use 'dotnet run test' to run shift assignment tests");
        }

        static void RunShiftAssignmentTests()
        {
        ...
        static void TestUniqueShiftIDGeneration()
        {
        ...
        static void TestShiftPersistence()
        {
        ...
        static void TestEmployeeNameResolution()
        {
